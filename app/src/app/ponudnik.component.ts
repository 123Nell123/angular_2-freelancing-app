...
export class ponudnikView {
  ...
  alert_string: string = "You did not fill out all the required input fields";

  @ViewChild('joblist') joblist;
  @ViewChild('inputprice') inputprice;
  @ViewChild('searchUsersByCategorie') searchUsersByCategorie_;
  jobs: Job_class[] = [];
  private_jobs: Private_job_class[] = [];
  public_or_private_jobs: boolean = true;
  errorMessage: any = '';
  private_job_notification: any = "";
  categories: Categorie[] = [];
  job_list_mode: string = "Private jobs";
  users: User[] = [];
  recommendedUsersVisible: boolean = false;
  showSkills = false;
  showBio = false;
  ...
  individualJobReceiversFullname = "";
  mode = "all";
