...
export class povprasevalecView {
  ...
  private job_list_mode: string = "Received private jobs";
  private categories: any[] = [];
  private selected_categorie: string = "";
  private new_subscribed_categories: subscribedCategorie_class[] = [];
  private subscribed_categories: any[] = [];
  private registeredPovprasevalec: boolean;
  private jobs: Job_class[] = [];
  private private_received_jobs: Private_jobpovprasevalec_class[] = [];
  private allow_offers: boolean[];
  ...
  private mode = "all";
  private NumberOfPendingPrivateJobs: number = null;
  private modalOffersType: number = -1;
